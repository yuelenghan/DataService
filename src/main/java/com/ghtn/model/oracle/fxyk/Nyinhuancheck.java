 ...
 */
@Entity
@IdClass(NyinhuancheckPK.class)
public class Nyinhuancheck {
    ...
    @Basic
    @Column(name = "RESPONSIBLEID", nullable = true, insertable = true, updatable = true, length = 100, precision = 0)
    ...
    @Basic
    @Column(name = "RESPONSIBLEDEPT", nullable = true, insertable = true, updatable = true, length = 100, precision = 0)
    ...
    @Basic
    @Column(name = "RESPONSIBLEBD", nullable = true, insertable = true, updatable = true, length = 100, precision = 0)
    public String getResponsiblebd() {
        return responsiblebd;
    }

    public void setResponsiblebd(String responsiblebd) {
        this.responsiblebd = responsiblebd;
    }
    ...
    public boolean equals(Object o) {
        ...
        Nyinhuancheck that = (Nyinhuancheck) o;
        ...
        if (responsiblebd != null ? !responsiblebd.equals(that.responsiblebd) : that.responsiblebd != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (responsiblebd != null ? responsiblebd.hashCode() : 0);
        return result;
    }
}
