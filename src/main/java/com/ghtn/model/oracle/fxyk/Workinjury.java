...
public class Workinjury {
    ...
    private BigDecimal gsLevelid;

    @Basic
    @javax.persistence.Column(name = "GS_LEVELID", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getGsLevelid() {
        return gsLevelid;
    }

    public void setGsLevelid(BigDecimal gsLevelid) {
    ...
    private BigDecimal pointsPer;

    @Basic
    @javax.persistence.Column(name = "POINTS_PER", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getPointsPer() {
        return pointsPer;
    }

    public void setPointsPer(BigDecimal pointsPer) {
        this.pointsPer = pointsPer;
    }

    private BigDecimal finePer;

    @Basic
    @javax.persistence.Column(name = "FINE_PER", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getFinePer() {
        return finePer;
    }

    public void setFinePer(BigDecimal finePer) {
        this.finePer = finePer;
    }

    private BigDecimal pointsDept;

    @Basic
    @javax.persistence.Column(name = "POINTS_DEPT", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getPointsDept() {
        return pointsDept;
    }

    public void setPointsDept(BigDecimal pointsDept) {
        this.pointsDept = pointsDept;
    }

    private BigDecimal fineDept;

    @Basic
    @javax.persistence.Column(name = "FINE_DEPT", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getFineDept() {
        return fineDept;
    }

    public void setFineDept(BigDecimal fineDept) {
    ...
    private BigDecimal pointsBz;

    @Basic
    @javax.persistence.Column(name = "POINTS_BZ", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    public BigDecimal getPointsBz() {
        return pointsBz;
    }

    public void setPointsBz(BigDecimal pointsBz) {
