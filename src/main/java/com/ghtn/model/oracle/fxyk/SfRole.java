...
public class SfRole {
    ...
    @Id
    @Column(name = "ROLEID", nullable = false, insertable = true, updatable = true, length = 0, precision = -127)
    ...
    @Basic
    @Column(name = "ROLENAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Basic
    @Column(name = "ROLEABOUT", nullable = true, insertable = true, updatable = true, length = 100, precision = 0)
    ...
    @Basic
    @Column(name = "ROLESTATUS", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
    ...
    @Basic
    @Column(name = "LEVELID", nullable = true, insertable = true, updatable = true, length = 0, precision = -127)
    ...
    @Basic
    @Column(name = "MAINDEPTID", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
