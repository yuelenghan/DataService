 ...
 */
@Entity
@IdClass(SwfinesetPK.class)
public class Swfineset {
    private int levelid;
    private int pid;
    ...
    public boolean equals(Object o) {
        ...
        Swfineset swfineset = (Swfineset) o;

        if (levelid != swfineset.levelid) return false;
        if (pid != swfineset.pid) return false;
        if (deptnumber != null ? !deptnumber.equals(swfineset.deptnumber) : swfineset.deptnumber != null) return false;
        if (kcfine != null ? !kcfine.equals(swfineset.kcfine) : swfineset.kcfine != null) return false;
        if (usingtime != null ? !usingtime.equals(swfineset.usingtime) : swfineset.usingtime != null) return false;
        if (zcfine != null ? !zcfine.equals(swfineset.zcfine) : swfineset.zcfine != null) return false;
