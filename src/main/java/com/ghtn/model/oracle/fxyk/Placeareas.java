...
public class Placeareas {
    ...
    @Id
    @Column(name = "PAREASID", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Basic
    @Column(name = "PAREASNAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Basic
    @Column(name = "STATUS", nullable = true, insertable = true, updatable = true, length = 30, precision = 0)
