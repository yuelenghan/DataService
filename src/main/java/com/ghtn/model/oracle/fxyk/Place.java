...
public class Place {
    ...
    @Id
    @Column(name = "PLACEID", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Basic
    @Column(name = "PLACENUMBER", nullable = true, insertable = true, updatable = true, length = 40, precision = 0)
    ...
    @Basic
    @Column(name = "PLACENAME", nullable = true, insertable = true, updatable = true, length = 80, precision = 0)
    ...
    @Basic
    @Column(name = "PLID", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Basic
    @Column(name = "PAREASID", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Basic
    @Column(name = "PLACESTATUS", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
