...
public class Yhpersistence {
    ...
    @Basic
    @Column(name = "ZRDEPTNAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Basic
    @Column(name = "ZRPERNAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
